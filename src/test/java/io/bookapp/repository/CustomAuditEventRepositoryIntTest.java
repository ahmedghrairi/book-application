...
import io.bookapp.config.audit.AuditEventConverter;
import io.bookapp.domain.PersistentAuditEvent;
...
import static io.bookapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
